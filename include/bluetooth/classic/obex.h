...
#ifndef __INCLUDE_BLUETOOTH_OBEX_H__
#define __INCLUDE_BLUETOOTH_OBEX_H__
 ...
 *
 *  len = MIN(len - buf->len, bt_buf_tailroom(buf));
...
struct bt_obex_server_ops {
	 ...
	 *  @param buf Sequence of headers.
	 */
	void (*disconnect)(struct bt_obex_server *server, struct bt_buf *buf);
	 ...
	 *  @param buf Sequence of headers.
	 */
	void (*put)(struct bt_obex_server *server, bool final, struct bt_buf *buf);
	 ...
	 *  @param buf Sequence of headers.
	 */
	void (*get)(struct bt_obex_server *server, bool final, struct bt_buf *buf);
	 ...
	 */
	void (*abort)(struct bt_obex_server *server, struct bt_buf *buf);
	 ...
	 *  @param buf Optional headers.
	 */
	void (*setpath)(struct bt_obex_server *server, uint8_t flags, struct bt_buf *buf);
	 ...
	 */
	void (*action)(struct bt_obex_server *server, bool final, struct bt_buf *buf);
};
...
struct bt_obex_client_ops {
	 ...
	 *  @param buf Sequence of headers.
	 */
	void (*disconnect)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 */
	void (*put)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 *  @param buf Optional response headers.
	 */
	void (*get)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 *  @param buf Optional response headers.
	 */
	void (*abort)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 *  @param buf Optional response headers.
	 */
	void (*setpath)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 *  @param buf Optional response headers.
	 */
	void (*action)(struct bt_obex_client *client, uint8_t rsp_code, struct bt_buf *buf);
};
...
struct bt_obex_transport_ops {
	 ...
	 */
	struct bt_buf *(*alloc_buf)(struct bt_obex *obex, struct bt_buf_pool *pool);
	 ...
	 */
	int (*send)(struct bt_obex *obex, struct bt_buf *buf);
 ...
 *  @return 0 in case of success or negative value in case of error.
 */
static inline int bt_obex_add_header_body_or_end_body(struct bt_buf *buf, uint16_t mopl,
						      ...
						      uint16_t *added_len)
{
	...
	*added_len = 0;
	...
	tx_len = MIN((tx_len - buf->len), bt_buf_tailroom(buf));
 ...
 *  @return 0 in case of success or negative value in case of error.
 */
int bt_obex_add_header_app_param(struct bt_buf *buf, size_t count,
...
#endif /* __INCLUDE_BLUETOOTH_OBEX_H__ */
