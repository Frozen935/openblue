...
#define BT_ATT_TIMEOUT		OS_SECONDS(BT_ATT_TIMEOUT_SEC)
...
typedef int (*bt_att_encode_t)(struct bt_buf *buf, size_t len,
			       void *user_data);
...
struct bt_buf *bt_att_create_pdu(struct bt_conn *conn, uint8_t op,
				  size_t len);
