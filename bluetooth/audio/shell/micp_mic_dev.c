...
static int cmd_micp_mic_dev_param(const struct bt_shell *sh, size_t argc,
				  char **argv)
{
	int result;
	...
	if (result != 0) {
		bt_shell_error(sh, "MICP register failed: %d", result);
		return result;
	}

	bt_shell_print(sh, "MICP initialized: %d", result);

#if defined(CONFIG_BT_MICP_MIC_DEV_AICS)
	result = bt_micp_mic_dev_included_get(&micp_included);
	if (result != 0) {
		bt_shell_error(sh, "MICP get failed: %d", result);
	}
#endif /* CONFIG_BT_MICP_MIC_DEV_AICS */
...
static int cmd_micp_mic_dev_mute_get(const struct bt_shell *sh, size_t argc,
				     char **argv)
{
	int result = bt_micp_mic_dev_mute_get();

	if (result != 0) {
		bt_shell_error(sh, "Fail: %d", result);
	}

	return result;
}

static int cmd_micp_mic_dev_mute(const struct bt_shell *sh, size_t argc,
				 char **argv)
{
...
static int cmd_micp_mic_dev_unmute(const struct bt_shell *sh, size_t argc,
				   char **argv)
{
...
static int cmd_micp_mic_dev_mute_disable(const struct bt_shell *sh, size_t argc,
					 char **argv)
{
...
#if defined(CONFIG_BT_MICP_MIC_DEV_AICS)
static int cmd_micp_mic_dev_aics_deactivate(const struct bt_shell *sh, size_t argc,
					    char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_activate(const struct bt_shell *sh, size_t argc,
					  char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_state_get(const struct bt_shell *sh,
...
static int cmd_micp_mic_dev_aics_gain_setting_get(const struct bt_shell *sh,
						  size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_type_get(const struct bt_shell *sh,
						size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_status_get(const struct bt_shell *sh,
						  size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_unmute(const struct bt_shell *sh,
					      size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_mute(const struct bt_shell *sh, size_t argc,
					    char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_manual_input_gain_set(const struct bt_shell *sh,
						       size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_automatic_input_gain_set(const struct bt_shell *sh,
							  size_t argc,
							  char **argv)
{
	unsigned long index;
...
static int cmd_micp_mic_dev_aics_gain_set(const struct bt_shell *sh, size_t argc,
					  char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_description_get(const struct bt_shell *sh,
						       size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev_aics_input_description_set(const struct bt_shell *sh,
						       size_t argc, char **argv)
{
	unsigned long index;
	int result = 0;
...
static int cmd_micp_mic_dev(const struct bt_shell *sh, size_t argc, char **argv)
{
	if (argc > 1) {
...
BT_SHELL_STATIC_SUBCMD_SET_CREATE(micp_mic_dev_cmds,
	BT_SHELL_CMD_ARG(init, NULL,
		      "Initialize the service and register callbacks",
		      cmd_micp_mic_dev_param, 1, 0),
	BT_SHELL_CMD_ARG(mute_get, NULL,
		      "Get the mute state",
...
BT_SHELL_CMD_ARG_REGISTER(micp_mic_dev, &micp_mic_dev_cmds,
