...
#ifndef __INCLUDE_BLUETOOTH_AVRCP_H__
#define __INCLUDE_BLUETOOTH_AVRCP_H__
...
struct bt_avrcp_ct_cb {
	 ...
	 */
	void (*get_caps)(struct bt_avrcp_ct *ct, uint8_t tid, uint8_t status, struct bt_buf *buf);
	 ...
	 */
	void (*set_browsed_player)(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_folder_items)(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_item_attrs)(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_total_number_of_items)(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*search)(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
...
/**
 * @brief Allocate a bt_buf for AVRCP PDU transmission, reserving headroom
 ...
 *
 * @return A newly allocated bt_buf with reserved headroom.
 */
struct bt_buf *bt_avrcp_create_pdu(struct bt_buf_pool *pool);

/**
 * @brief Allocate a bt_buf for AVRCP Vendor-Dependent PDU transmission, reserving
 ...
 *  @return 0 on success or error code.
 */
int bt_avrcp_ct_get_element_attrs(struct bt_avrcp_ct *ct, uint8_t tid, struct bt_buf *buf);
...
struct bt_avrcp_tg_cb {
	 ...
	 *             Note that all multi-octet fields are encoded in big-endian format.
	 */
	void (*get_folder_items)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that all multi-octet fields are encoded in big-endian format.
	 */
	void (*change_path)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *             Note that all multi-octet fields are encoded in big-endian format.
	 */
	void (*get_item_attrs)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *
	 */
	void (*search)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 */
	void (*passthrough_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *            The application should parse fields in big-endian order.
	 */
	void (*get_element_attrs)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *            The application should parse fields in big-endian order.
	 */
	void (*play_item)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
	 ...
	 *            The application should parse fields in big-endian order.
	 */
	void (*add_to_now_playing)(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
};
 ...
 *  @return 0 in case of success or error code in case of error.
 */
int bt_avrcp_tg_get_total_number_of_items(struct bt_avrcp_tg *tg, uint8_t tid, struct bt_buf *buf);
...
#endif /* __INCLUDE_BLUETOOTH_AVRCP_H__ */
