...
static void tg_bip_disconnect(struct bt_bip_server *server, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_tg *tg = COVER_ART_TG_FROM_SERVER(server);
...
static void tg_bip_abort(struct bt_bip_server *server, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_tg *tg = COVER_ART_TG_FROM_SERVER(server);
...
static void tg_bip_get_image(struct bt_bip_server *server, bool final, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_tg *tg = COVER_ART_TG_FROM_SERVER(server);
...
static void ct_bip_disconnect(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_ct *ct = COVER_ART_CT_FROM_CLIENT(client);
...
static void ct_bip_abort(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_ct *ct = COVER_ART_CT_FROM_CLIENT(client);
...
static void ct_bip_get_image(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf)
{
	struct bt_avrcp_cover_art_ct *ct = COVER_ART_CT_FROM_CLIENT(client);
