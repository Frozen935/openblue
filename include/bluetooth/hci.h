 ...
 */
#ifndef __INCLUDE_BLUETOOTH_HCI_H__
#define __INCLUDE_BLUETOOTH_HCI_H__
...
/** Send a HCI command synchronously.
  ...
  *               for calling bt_buf_unref() on the buffer when done parsing
  *               it.
  *
  * @return 0 on success or negative error value on failure.
  */
...
/** @typedef bt_hci_vnd_evt_cb_t
  ...
  */
typedef bool bt_hci_vnd_evt_cb_t(struct bt_buf_simple *buf);
...
#endif /* __INCLUDE_BLUETOOTH_HCI_H__ */
