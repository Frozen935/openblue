...
#ifndef __INCLUDE_BLUETOOTH_SERVICES_NUS_INST_H__
#define __INCLUDE_BLUETOOTH_SERVICES_NUS_INST_H__
...
BT_GATT_SERVICE_DEFINE(_name##_svc,								   \
	...
	BT_GATT_CHARACTERISTIC(BT_UUID_NUS_RX_CHAR,						   \
		...
		NULL, nus_bt_chr_write, NULL),							   \
												   ...
												   \
bt_slist_t _name##_cbs = BT_SLIST_STATIC_INIT(&_name##_cbs);					   \
												   \
...
#endif /* __INCLUDE_BLUETOOTH_SERVICES_NUS_INST_H__ */
