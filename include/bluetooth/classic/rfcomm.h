 ...
 */
#ifndef __INCLUDE_BLUETOOTH_RFCOMM_H__
#define __INCLUDE_BLUETOOTH_RFCOMM_H__
...
struct bt_rfcomm_dlc_ops {
	 ...
	 */
	void (*recv)(struct bt_rfcomm_dlc *dlc, struct bt_buf *buf);
...
#endif /* __INCLUDE_BLUETOOTH_RFCOMM_H__ */
