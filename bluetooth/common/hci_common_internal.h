...
#define BT_BUF_CMD_TX_REMOTE_VERSION       UTIL_COND_CODE(CONFIG_BT_REMOTE_VERSION, (1), (0))
...
#define BT_BUF_CMD_TX_AUTO_DATA_LEN_UPDATE UTIL_COND_CODE(CONFIG_BT_AUTO_DATA_LEN_UPDATE, (1), (0))
