...
#define BT_MESH_MODEL_KEYS_UNUSED(_keys)			\
	{ UTIL_LISTIFY(_keys, BT_MESH_KEY_UNUSED_ELT_, (,)) }
#define BT_MESH_MODEL_GROUPS_UNASSIGNED(_grps)			\
	{ UTIL_LISTIFY(_grps, BT_MESH_ADDR_UNASSIGNED_ELT_, (,)) }
#if CONFIG_BT_MESH_LABEL_COUNT > 0
#define BT_MESH_MODEL_UUIDS_UNASSIGNED()			\
	.uuids = (const uint8_t *[]){ UTIL_LISTIFY(CONFIG_BT_MESH_LABEL_COUNT, \
...
#define BT_MESH_MODEL_PUB_DEFINE(_name, _update, _msg_len) \
	BT_BUF_SIMPLE_DEFINE_STATIC(bt_mesh_pub_msg_##_name, _msg_len); \
...
#endif /* __INCLUDE_BLUETOOTH_MESH_ACCESS_H__ */
