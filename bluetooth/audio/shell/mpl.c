...
int cmd_mpl_test_set_media_state(const struct bt_shell *sh, size_t argc,
				 char *argv[])
{
	unsigned long state;
	int err = 0;
...
int cmd_mpl_test_unset_parent_group(const struct bt_shell *sh, size_t argc,
				    char *argv[])
{
...
int cmd_mpl_debug_dump_state(const struct bt_shell *sh, size_t argc,
			     char *argv[])
{
...
int cmd_media_proxy_pl_init(const struct bt_shell *sh, size_t argc, char *argv[])
{
...
#if defined(CONFIG_BT_TESTING)
int cmd_mpl_test_player_name_cb(const struct bt_shell *sh, size_t argc,
				char *argv[])
{
...
int cmd_mpl_test_player_icon_url_cb(const struct bt_shell *sh, size_t argc,
				    char *argv[])
{
...
int cmd_mpl_test_track_changed_cb(const struct bt_shell *sh, size_t argc,
				  char *argv[])
{
...
int cmd_mpl_test_title_changed_cb(const struct bt_shell *sh, size_t argc,
				  char *argv[])
{
...
int cmd_mpl_test_duration_changed_cb(const struct bt_shell *sh, size_t argc,
				     char *argv[])
{
...
int cmd_mpl_test_position_changed_cb(const struct bt_shell *sh, size_t argc,
				     char *argv[])
{
...
int cmd_mpl_test_playback_speed_changed_cb(const struct bt_shell *sh, size_t argc,
					   char *argv[])
{
...
int cmd_mpl_test_seeking_speed_changed_cb(const struct bt_shell *sh, size_t argc,
					  char *argv[])
{
...
#ifdef CONFIG_BT_MPL_OBJECTS
int cmd_mpl_test_current_track_id_changed_cb(const struct bt_shell *sh, size_t argc,
					     char *argv[])
{
...
int cmd_mpl_test_next_track_id_changed_cb(const struct bt_shell *sh, size_t argc,
					  char *argv[])
{
...
int cmd_mpl_test_current_group_id_changed_cb(const struct bt_shell *sh, size_t argc,
					     char *argv[])
{
...
int cmd_mpl_test_parent_group_id_changed_cb(const struct bt_shell *sh, size_t argc,
					    char *argv[])
{
...
int cmd_mpl_test_playing_order_changed_cb(const struct bt_shell *sh, size_t argc,
					  char *argv[])
{
...
int cmd_mpl_test_state_changed_cb(const struct bt_shell *sh, size_t argc,
				  char *argv[])
{
...
int cmd_mpl_test_media_opcodes_supported_changed_cb(const struct bt_shell *sh, size_t argc,
						    char *argv[])
{
...
#ifdef CONFIG_BT_MPL_OBJECTS
int cmd_mpl_test_search_results_changed_cb(const struct bt_shell *sh, size_t argc,
					   char *argv[])
{
...
BT_SHELL_SUBCMD_SET_CREATE(mpl_cmds,
	...
	BT_SHELL_CMD_ARG(test_unset_parent_group, NULL,
		      "Set current group to be its own parent (test)",
		      cmd_mpl_test_unset_parent_group, 1, 0),
#endif /* CONFIG_BT_MPL_OBJECTS */
#endif /* CONFIG_BT_TESTING */
#if defined(CONFIG_BT_MPL_LOG_LEVEL_DBG)
	BT_SHELL_CMD_ARG(debug_dump_state, NULL,
