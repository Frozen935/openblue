...
struct bt_le_ext_adv {
	...
	struct bt_work_delayable	lim_adv_timeout_work;
...
struct bt_le_per_adv_sync {
	...
	struct bt_buf_simple reassembly;
...
struct bt_dev {
	...
	struct bt_work_delayable rpa_update;
...
extern bt_slist_t bt_auth_info_cbs;
...
/* HCI event handlers */
void bt_hci_pin_code_req(struct bt_buf *buf);
void bt_hci_link_key_notify(struct bt_buf *buf);
void bt_hci_link_key_req(struct bt_buf *buf);
void bt_hci_io_capa_resp(struct bt_buf *buf);
void bt_hci_io_capa_req(struct bt_buf *buf);
void bt_hci_ssp_complete(struct bt_buf *buf);
void bt_hci_user_confirm_req(struct bt_buf *buf);
void bt_hci_user_passkey_notify(struct bt_buf *buf);
void bt_hci_user_passkey_req(struct bt_buf *buf);
void bt_hci_auth_complete(struct bt_buf *buf);
...
void bt_hci_conn_req(struct bt_buf *buf);
void bt_hci_conn_complete(struct bt_buf *buf);


void bt_hci_inquiry_complete(struct bt_buf *buf);
void bt_hci_inquiry_result_with_rssi(struct bt_buf *buf);
void bt_hci_extended_inquiry_result(struct bt_buf *buf);
void bt_hci_remote_name_request_complete(struct bt_buf *buf);
