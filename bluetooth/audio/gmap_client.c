				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.bgr_feat = bt_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.bgs_feat = bt_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.ugt_feat = bt_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.ugg_feat = bt_buf_simple_pull_u8(&buf);
			    ...
			    struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->role = bt_buf_simple_pull_u8(&buf);
