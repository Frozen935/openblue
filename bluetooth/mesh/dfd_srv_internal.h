...
#ifndef __INCLUDE_BLUETOOTH_MESH_DFD_SRV_INTERNAL_H___
#define __INCLUDE_BLUETOOTH_MESH_DFD_SRV_INTERNAL_H___
...
#endif /* __INCLUDE_BLUETOOTH_MESH_DFD_SRV_INTERNAL_H__ */
