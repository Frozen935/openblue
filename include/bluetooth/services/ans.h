...
#ifndef __INCLUDE_BLUETOOTH_SERVICES_ANS_H__
#define __INCLUDE_BLUETOOTH_SERVICES_ANS_H__
 ...
 * control point.
 *
 * @note This function waits on a Mutex with @ref OS_TIMEOUT_FOREVER to ensure atomic updates to notification
...
#endif /* __INCLUDE_BLUETOOTH_SERVICES_ANS_H__ */
