...
#ifndef __INCLUDE_BLUETOOTH_AVRCP_COVER_ART_H__
#define __INCLUDE_BLUETOOTH_AVRCP_COVER_ART_H__
...
struct bt_avrcp_cover_art_ct_cb {
	 ...
	 * @param buf Response data buffer
	 */
	void (*disconnect)(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*abort)(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 */
	void (*get_image)(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf);
...
struct bt_avrcp_cover_art_tg_cb {
	 ...
	 * @param buf Request data buffer
	 */
	void (*disconnect)(struct bt_avrcp_cover_art_tg *tg, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*abort)(struct bt_avrcp_cover_art_tg *tg, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_image)(struct bt_avrcp_cover_art_tg *tg, bool final, struct bt_buf *buf);
 ...
 */
struct bt_buf *bt_avrcp_cover_art_ct_create_pdu(struct bt_avrcp_cover_art_ct *ct,
 ...
 * @return Allocated buffer or NULL on failure
 */
struct bt_buf *bt_avrcp_cover_art_tg_create_pdu(struct bt_avrcp_cover_art_tg *tg,
						 struct bt_buf_pool *pool);
 ...
 * @return 0 on success, negative error code on failure
 */
int bt_avrcp_cover_art_ct_abort(struct bt_avrcp_cover_art_ct *ct, struct bt_buf *buf);
...
#endif /* __INCLUDE_BLUETOOTH_AVRCP_COVER_ART_H__ */
