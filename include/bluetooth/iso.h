 ...
 */
#ifndef __INCLUDE_BLUETOOTH_ISO_H__
#define __INCLUDE_BLUETOOTH_ISO_H__
...
struct bt_iso_chan_ops {
	 ...
	 * To avoid any issues it is recommended to use a @ref bt_work_submit or similar to not
	 ...
	 */
	struct bt_buf *(*alloc_buf)(struct bt_iso_chan *chan);
	 ...
	 *             pointer is linked to the lifetime of the bt_buf.
...
#endif /* __INCLUDE_BLUETOOTH_ISO_H__ */
