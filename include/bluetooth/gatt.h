 ...
 */
#ifndef __INCLUDE_BLUETOOTH_GATT_H__
#define __INCLUDE_BLUETOOTH_GATT_H__
...
#define BT_GATT_SERVICE_INSTANCE_DEFINE(				 \
	...
	UTIL_LISTIFY(_instance_num, _BT_GATT_ATTRS_ARRAY_DEFINE, (;),	 \
...
#endif /* __INCLUDE_BLUETOOTH_GATT_H__ */
