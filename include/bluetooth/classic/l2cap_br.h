 ...
 */
#ifndef __INCLUDE_BLUETOOTH_L2CAP_BR_H__
...
struct bt_l2cap_br_echo_cb {
	 ...
	 */
	void (*req)(struct bt_conn *conn, uint8_t identifier, struct bt_buf *buf);
	 ...
	 * @param buf Received ECHO data.
	 */
	void (*rsp)(struct bt_conn *conn, struct bt_buf *buf);
...
struct bt_l2cap_br_connless_cb {
	 ...
	 */
	void (*recv)(struct bt_conn *conn, uint16_t psm, struct bt_buf *buf);
...
#endif /* __INCLUDE_BLUETOOTH_L2CAP_BR_H__ */
