...
/**
 *  @brief Define a Mesh model message buffer using @ref BT_BUF_SIMPLE_DEFINE.
 *
...
#define BT_MESH_MODEL_BUF_DEFINE(_buf, _op, _payload_len)                      \
	BT_BUF_SIMPLE_DEFINE(_buf, BT_MESH_MODEL_BUF_LEN(_op, (_payload_len)))
...
#endif /* __INCLUDE_BLUETOOTH_MESH_MSG_H__ */
