...
#ifndef __INCLUDE_BLUETOOTH_SERVICES_OTS_H__
#define __INCLUDE_BLUETOOTH_SERVICES_OTS_H__
...
static inline int bt_ots_obj_id_to_str(uint64_t obj_id, char *str, size_t len)
{
	...
	return snprintf(str, len, "0x%02X%02X%02X%02X%02X%02X",
...
#endif /* __INCLUDE_BLUETOOTH_SERVICES_OTS_H__ */
