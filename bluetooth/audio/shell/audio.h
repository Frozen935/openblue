...
#define CONTEXT                                                                                    \
	(BT_AUDIO_CONTEXT_TYPE_UNSPECIFIED | BT_AUDIO_CONTEXT_TYPE_CONVERSATIONAL |                \
	 ...
	 UTIL_COND_CODE(IS_ENABLED(CONFIG_BT_GMAP), (BT_AUDIO_CONTEXT_TYPE_GAME), (0)))
...
#define UNICAST_SERVER_STREAM_COUNT                                                                \
	UTIL_COND_CODE(CONFIG_BT_ASCS_ASE_SRC, (CONFIG_BT_ASCS_MAX_ASE_SRC_COUNT), (0)) +             \
	UTIL_COND_CODE(CONFIG_BT_ASCS_ASE_SNK, (CONFIG_BT_ASCS_MAX_ASE_SNK_COUNT), (0))

#define UNICAST_CLIENT_STREAM_COUNT                                                                \
	UTIL_COND_CODE(CONFIG_BT_BAP_UNICAST_CLIENT,                                                  \
