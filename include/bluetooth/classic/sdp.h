 ...
 */
#ifndef __INCLUDE_BLUETOOTH_SDP_H__
#define __INCLUDE_BLUETOOTH_SDP_H__
 ...
 */
int bt_sdp_get_proto_param(const struct bt_buf *buf, uint16_t proto,
			   uint16_t *param);
...
#endif /* __INCLUDE_BLUETOOTH_SDP_H__ */
