 ...
 */
#ifndef __INCLUDE_BLUETOOTH_BLUETOOTH_H__
#define __INCLUDE_BLUETOOTH_BLUETOOTH_H__
...
#define BT_LE_LOCAL_SUPPORTED_FEATURES_SIZE                         \
	(BT_HCI_LE_BYTES_PAGE_0_FEATURE_PAGE +                      \
	 UTIL_COND_CODE(CONFIG_BT_LE_MAX_LOCAL_SUPPORTED_FEATURE_PAGE, \
 ...
 * @ref bt_storage_load_subtree with argument "bt". The latter selectively loads only
 ...
 *          @ref bt_buf_simple_save to store the state prior to the function call, and then using
 *          @ref bt_buf_simple_restore to restore the state afterwards.
 *
 ...
 */
void bt_data_parse(struct bt_buf_simple *ad,
...
#endif /* __INCLUDE_BLUETOOTH_BLUETOOTH_H__ */
