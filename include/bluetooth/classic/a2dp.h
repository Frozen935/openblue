 ...
 */
#ifndef __INCLUDE_BLUETOOTH_A2DP_H__
#define __INCLUDE_BLUETOOTH_A2DP_H__
...
struct bt_a2dp_stream_ops {
	 ...
	 */
	void (*recv)(struct bt_a2dp_stream *stream, struct bt_buf *buf, uint16_t seq_num,
		     uint32_t ts);
#endif
...
/**
 * @brief Allocate a bt_buf for bt_a2dp_stream_send
 *
 ...
 *
 * @return A newly allocated bt_buf.
 */
...
#endif /* __INCLUDE_BLUETOOTH_A2DP_H__ */
