...
#ifndef __INCLUDE_BLUETOOTH_BIP_H__
#define __INCLUDE_BLUETOOTH_BIP_H__
...
struct bt_bip_server_cb {
	 ...
	 * @param buf Request data buffer
	 */
	void (*disconnect)(struct bt_bip_server *server, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*abort)(struct bt_bip_server *server, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_caps)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_image_list)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_image_properties)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_image)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_linked_thumbnail)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_partial_image)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_monitoring_image)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*get_status)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*put_image)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*put_linked_thumbnail)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*remote_display)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*delete_image)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*start_print)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
	 ...
	 * @param buf Request data buffer
	 */
	void (*start_archive)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
};
...
struct bt_bip_client_cb {
	 ...
	 * @param buf Response data buffer
	 */
	void (*disconnect)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*abort)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*get_caps)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*get_image_list)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*get_image)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*get_status)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*put_image)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*remote_display)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*delete_image)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*start_print)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
	 ...
	 * @param buf Response data buffer
	 */
	void (*start_archive)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
};
...
struct bt_bip_server {
	...
	void (*_req_cb)(struct bt_bip_server *server, bool final, struct bt_buf *buf);
...
struct bt_bip_client {
	...
	void (*_rsp_cb)(struct bt_bip_client *client, uint8_t rsp_code, struct bt_buf *buf);
...
#endif /* __INCLUDE_BLUETOOTH_BIP_H__ */
