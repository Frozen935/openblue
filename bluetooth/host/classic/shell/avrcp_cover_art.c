...
static int cover_art_parse_headers(struct bt_buf *buf)
{
	int err;
...
static void tg_disconnect(struct bt_avrcp_cover_art_tg *tg, struct bt_buf *buf)
{
	bt_shell_print("Cover Art TG %p disconn req", tg);
	cover_art_parse_headers(buf);
}

static void tg_abort(struct bt_avrcp_cover_art_tg *tg, struct bt_buf *buf)
{
...
static void tg_get_image(struct bt_avrcp_cover_art_tg *tg, bool final, struct bt_buf *buf)
{
...
static void ct_disconnect(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf)
{
...
static void ct_get_image(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf)
{
...
static void ct_abort(struct bt_avrcp_cover_art_ct *ct, uint8_t rsp_code, struct bt_buf *buf)
{
