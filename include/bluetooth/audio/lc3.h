 ...
 */
#ifndef __INCLUDE_BLUETOOTH_AUDIO_LC3_H__
#define __INCLUDE_BLUETOOTH_AUDIO_LC3_H__
 ...
 *
 * @ref UTIL_COND_CODE is used to omit an LTV entry in case the @p _frames_per_sdu is 1.
 * @ref UTIL_COND_CODE will evaluate to second argument if the flag parameter(first argument) is 1
...
#define BT_AUDIO_CODEC_CAP_LC3_DATA(_freq, _duration, _chan_count, _len_min, _len_max,             \
	...
	{                                                                                          \
		...
		UTIL_COND_CODE(_max_frames_per_sdu, (),                                               \
...
#define BT_AUDIO_CODEC_CFG_LC3_DATA(_freq, _duration, _loc, _len, _frames_per_sdu)                 \
	{                                                                                          \
		...
		UTIL_COND_CODE(_frames_per_sdu, (),                                                   \
...
#endif /* __INCLUDE_BLUETOOTH_AUDIO_LC3_H__ */
