...
#ifndef __BLUETOOTH_HOST_BUF_VIEW_H__
 ...
 *
 *  @note The `headroom` param is only used for __ASSERT_MSG(). The idea is that
 ...
 *
 *  Equivalent of @ref bt_buf_destroy.
...
#endif /* __BLUETOOTH_HOST_BUF_VIEW_H__ */
